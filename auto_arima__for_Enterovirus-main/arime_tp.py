...
def prediction_G(Data,i):
    ...
    arima_model =pm.auto_arima(train, start_p=1, d=1, start_q=2,max_p=2, max_d=1, max_q=2,
                           start_P=1, D=1, start_Q=2, max_P=2, max_D=1,
                           max_Q=2, m=24, seasonal=True,
                           stationary=False,
                           error_action='warn', trace=True,
                           suppress_warnings=True, stepwise=True,n_fits=15)
